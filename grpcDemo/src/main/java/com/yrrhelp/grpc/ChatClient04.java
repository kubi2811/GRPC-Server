...
public class ChatClient04 {
    ...
    public ChatClient04(String name, String serverAddress, int serverPort) {
        this.name = name;
    ...
    public static void main(String[] args) {
        ...
        ChatClient04 client = new ChatClient04(name, serverAddress, serverPort);
        client.connect();
